...
public class Victory extends JPanel {
	private static final long serialVersionUID = -5414474960795285145L;
	...
	public Victory(int a ,int b ,int c ,int d,int e,int f ,int g ,int h ,int i ,int j )throws IOException, UnsupportedAudioFileException, LineUnavailableException	
	{   
		...
		imageBG = ImageIO.read(new File("Images & Sounds\\victory.jpg"));
		...
		JEndGame.setBounds(LogRegScreen.width/2-180,LogRegScreen.height-125,350,90);
		add(JEndGame);
